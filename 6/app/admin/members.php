...
class InternationalExample extends Common
{
	...
	{
		$tableColumns['member_id'] = array(
			'display_text' => 'ID', 
			'perms' => 'TVQSXO'
		);
		
		$tableColumns['login'] = array(
			'display_text' => 'Login <br><span class="popisek">Pro nejvyšší úroveň (=tuto), je povolený a vyžadovaný pouze login "superadmin"</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
		);
		
		$tableColumns['passwd'] = array(
			'display_text' => 'Heslo', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
