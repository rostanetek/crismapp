...
class InternationalExample extends Common
{
	...
	protected function initiateEditor()
	{
		...
		$tableColumns['odkaz'] = array(
			'display_text' => 'Odkaz<br><span class="popisek">vložte odkaz na <a href="http://leaflet-extras.github.io/leaflet-providers/preview/" target="_blank">L.TileLayer</a> nebo WMS</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
		);
		
		$tableColumns['maxZoom'] = array(
			'display_text' => 'maxZoom<br><span class="popisek">doporučeno 22</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
		);
		
		$tableColumns['maxNativeZoom'] = array(
			'display_text' => 'maxNativeZoom<br><span class="popisek">doporučeno 18</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
		);
		
		$tableColumns['attribution'] = array(
			'display_text' => 'Popisek/Copyright<br><span class="popisek">v pravém spodním rohu mapy</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true
		);
		...
		$tableColumns['zobrazeno'] = array(
			'display_text' => 'Zobrazeno<br><span class="popisek">ano/ne</span>', 
			'perms' => 'EVCTAXQSHOF', 'req' => true,
