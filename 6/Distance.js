...
L.Control.Distance = L.Control.extend({
	...
	onAdd: function(map) {
		...
		var link = this._link = this._createButton('Zapnout/vypnout mìøení', 'leaflet-control-distance leaflet-control-distance-edit', container, cb, this);
		var del = this._link_delete = this._createButton('Smazat trasu', 'leaflet-control-distance leaflet-control-distance-delete', container, this._reset, this);
