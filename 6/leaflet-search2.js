...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		autoCollapseTime: 30000,		//delay for autoclosing alert and collapse after blur
		zoom: 18,					//zoom after pan to location found, default: map.getZoom()
...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
	...
	setLayer: function(layer) {	//set search layer at runtime
		...
		this._layer = layer;
		//this._layer.addTo(this._map); // tady odebrano
		if(this._markerLoc)
	...
	expand: function() {	
		...
		L.DomUtil.addClass(this._container, 'search-exp2');	
		//tadyy this._input.focus();
	...
	collapse: function() {
		...
		if(this.options.collapsed)
		{
			...
			this._cancel.style.display = 'none';			
			L.DomUtil.removeClass(this._container, 'search-exp2');		
...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
	...
	showLocation: function(latlng, title) {	//set location on map from _recordsCache
		this._layer.addTo(this._map); // tady pridano
